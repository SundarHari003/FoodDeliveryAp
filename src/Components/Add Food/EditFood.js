  ...
  return (
    <div className=" p-3 bg-gray-50 bg-opacity-30">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-[60%,40%] gap-2 pt-3 pe-2">
            ...
            <div className=" grid grid-cols-1 gap-5">
              ...
              <div className=" grid grid-cols-1 gap-2">
                ...
                <textarea
                  ...
                  value={foodName}
                  onChange={(e) => setFoodName(e.target.value)}
                  placeholder=" Update Food Description"
                  className={` rounded-md border border-gray-200 ${foodName ? " bg-white" : "bg-gray-50"} p-1 focus:outline-orange-400`} />
              </div>
            </div>
          </div>
            ...
            <div className=" grid grid-cols-2 p-3 gap-3">
              ...
              <div className=" grid grid-cols-1 gap-2">
                ...
                <input
                  ...
                  onChange={(e) => setFoodPrice(e.target.value)}
                  className={` rounded-md border border-gray-200 ${foodName ? " bg-white" : "bg-gray-50"} p-1 focus:outline-orange-400`}
                  placeholder=" Update Food Quantity"
                />
              </div>
              <div className=" grid grid-cols-1 gap-2">
              ...
              <div className=" grid grid-cols-1 gap-2">
                ...
                <input
                  ...
                  onChange={(e) => setFoodPrice(e.target.value)}
                  className={` rounded-md border border-gray-200 ${foodName ? " bg-white" : "bg-gray-50"} p-1 focus:outline-orange-400`}
                  placeholder=" Update Discount Type"
                />
              </div>
            </div>
          </div>
        ...
        <div className=" grid grid-cols-1 gap-2 ">
          <div className=" border border-gray-200 rounded-md bg-gray-100 bg-opacity-60  p-3">
            <h1 className=" text-lg font-medium text-gray-700 pt-1">Update Food Image</h1>
            <div className="flex items-center justify-center gap-2 flex-col">
              <RiImageAddFill className=" h-[15rem] text-gray-400 w-auto" />
              <button type=" button" className=" text-white bg-orange-400 px-2 py-1 rounded-md">+ Update Image</button>
            </div>
          </div>
